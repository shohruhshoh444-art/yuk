        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="contact-form">
                    <h4 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=676">Pro Version</a> only.</h4>
                    <form>
                        <div class="row">
                            <div class="col-md-6">
